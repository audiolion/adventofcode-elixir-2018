...
defmodule AOC.Day1 do
  def find_frequency(data) do
    ...
    Enum.reduce_while(stream, %{frequency: 0, frequencies: MapSet.new},
      fn(x, %{frequency: frequency, frequencies: frequencies}) ->
        ...
        case MapSet.member?(frequencies, next_frequency) do
          ...
          false -> {:cont, %{frequency: next_frequency, frequencies: MapSet.put(frequencies, next_frequency)}}
        end
      end
    )
  end
